...
/* flip: Refleja una imagen en su eje Horizontal o Vertical
/  Donde Horizontal intercambia los valores de las columnas ><
/  y Vertical intercambia los valores de las filas  ^v .
...
/  Utilice la funcion get_gauss_item, para armar el kernel.
